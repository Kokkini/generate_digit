...
cell_1 = tf.nn.rnn_cell.BasicRNNCell(num_units=n_neurons_1)
cell_2 = tf.nn.rnn_cell.BasicRNNCell(num_units=n_neurons_2)
multi_layer_cell = tf.nn.rnn_cell.MultiRNNCell([cell_1,cell_2])
states, fin_state = tf.nn.dynamic_rnn(multi_layer_cell,X,dtype=tf.float32)
